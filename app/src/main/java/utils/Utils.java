...
//    public static ShowCaseNewDesign(){
//        RelativeLayout.LayoutParams lps = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
//        lps.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
//        lps.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
//        int margin = ((Number) (ExploreActivity.activity.getResources().getDisplayMetrics().density * 12)).intValue();
//        lps.setMargins(margin, margin, margin, margin);
//
//        ViewTarget target = new ViewTarget(R.id.buttonBlocked, this);
//        sv = new ShowcaseView.Builder(ExploreActivity.activity)
...
//                    myMsg.setText("Invalid Password Format");
